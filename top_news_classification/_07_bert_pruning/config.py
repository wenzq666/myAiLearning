...
class Config(object):
    def __init__(self):
        ...
        # 5. 剪枝模型存放地址
        self.bert_model_pruning_model_path = self.root_path + "_07_bert_pruning/save_models/bert_classifier_pruning_model.pt"  # 模型训练结果保存路径
...
if __name__ == '__main__':
    ...
    # 4. 查看保存模型的路径.
    print(conf.bert_model_pruning_model_path)
